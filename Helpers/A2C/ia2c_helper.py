...
class BatchTraining:
    ...
    def collate_batch(self, batch_buffer, batch_rtrns):
        ...
        for episode_buffer, episode_rtrns in zip(batch_buffer, batch_rtrns):
            ...
            # Stack actions: [timesteps, num_agents, action_features]
            episode_actions = []
            for action_per_timestep in episode_buffer['actions']:
                ...
                # If each action has features (e.g., action embedding), adjust accordingly
        ...
        return batch_observations, batch_actions, batch_rtrns